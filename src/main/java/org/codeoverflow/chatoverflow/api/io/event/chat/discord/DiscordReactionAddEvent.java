 ...
 */
public class DiscordReactionAddEvent extends DiscordReactionEvent {

    public DiscordReactionAddEvent(DiscordChatMessage message, DiscordReaction reaction) {
        super(message, reaction);
    }

    public DiscordReactionAddEvent(DiscordChatMessage message, DiscordReaction reaction, OffsetDateTime time) {
